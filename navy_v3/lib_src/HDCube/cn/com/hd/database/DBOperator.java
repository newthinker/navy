...
/*     */         {
/* 386 */           if (resultSetMetaData.getColumnTypeName(columnIndex + 1)
/* 386 */             .equals("DATE"))
...
/*     */         {
/* 455 */           if (resultSetMetaData.getColumnTypeName(columnIndex + 1)
/* 455 */             .equals("DATE"))
...
/*     */         {
/* 526 */           if (resultSetMetaData.getColumnTypeName(columnIndex + 1)
/* 526 */             .equals("DATE"))
...
/* 756 */       int tempid = 1024;
/* 757 */       byte[] buffer = new byte[tempid];
/*     */       int writeLength;
