...
/*    */ 
/*    */ public class FuncTreeService extends BaseService implements IService {
...
/*    */ 
/* 43 */     String sExp = "exists (" + 
				"select 1 from t_role_func dto2, t_user_role dto3,t_role dto4 " + 
				"where dto1.function_id = dto2.function_id and dto2.role_id = dto3.role_id " + 
				"and dto3.role_id = dto4.role_id and dto1.validated = 'Y' " + 
				"and dto4.validated = 'Y' and dto3.user_id = '" + 
