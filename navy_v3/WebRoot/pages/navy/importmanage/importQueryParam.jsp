...
<div class="searchTbl"
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
		...
		<tr>
			...
			<td align="left">
				<input id="STR_QUERY_COMPACT" name="STR_QUERY_COMPACT" style="width:150px"
					value="<%= queryParam.getString("QUERY_COMPACT") == null ? "" : queryParam.getString("QUERY_COMPACT") %>" />
			</td>
		</tr>
		<tr>
			<td align="right">
			...
			<td align="left" colspan="3">
				<input name="DAT_QUERY_COMPACTDATEBEFORE" id="DAT_QUERY_COMPACTDATEBEFORE" style="cursor:hand;"
					onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',qsEnabled:true,quickSel:['2000-1-10','2000-2-20']})"
					type="text" style="width:150px;" readonly="readonly" class="Wdate"
					value="<%= queryParam.showDate("QUERY_COMPACTDATEBEFORE") %>" />
				&nbsp;至&nbsp;	
				<input name="DAT_QUERY_COMPACTDATEAFTER" id="DAT_QUERY_COMPACTDATEAFTER" style="cursor:hand;"
					onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',qsEnabled:true,quickSel:['2000-1-10','2000-2-20']})"
					type="text" style="width:150px;" readonly="readonly" class="Wdate"
					value="<%= queryParam.showDate("QUERY_COMPACTDATEAFTER") %>" />
			</td>
		</tr>
	</table>
	<script type="text/javascript">
