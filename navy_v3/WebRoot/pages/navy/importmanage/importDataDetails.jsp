		...
		<form action="upload" method="post" enctype="multipart/form-data">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<td>
						<%= dto.getString("CURRENCY") == null ? "&nbsp;" : dto.getString("CURRENCY") %>
					</td>
					<th>
						汇率
					</th>
					<td>
						<%= dto.getNumber("RATE") == null ? "&nbsp;" : dto.getNumber("RATE").doubleValue() %>
					</td>
				</tr>
				<tr>
					<th>
				...
				<tr>
					...
					<td>
						<%= dto.getString("AGENT") == null ? "&nbsp;" : dto.getString("AGENT") %>
					</td>
					<th>
						代理协议
					</th>
					<td>
						<a href="pages/navy/importmanage/images.jsp?importid=<%= dto.getString("IMPORTID") %>&typeid=<%= dto.getString("AGREEID") %>&type=AGREE" class="link_blue_table" target="_blank"><%= dto.getString("AGREE") == null ? "" : dto.getString("AGREE") %></a>&nbsp;
					</td>
				</tr>
				<tr>
					<th>
					...
					<td>
						<a href="pages/navy/importmanage/images.jsp?importid=<%= dto.getString("IMPORTID") %>&typeid=<%= dto.getString("EXAMINEID") %>&type=EXAMINE" class="link_blue_table" target="_blank"><%= dto.getString("EXAMINENO") == null ? "" : dto.getString("EXAMINENO") %></a>&nbsp;
					</td>
				</tr>
				<tr>
					<th>
				...
				<tr>
					...
					<td>
						<%= dto.getString("IMPORTCLASS") == null ? "&nbsp;" : dto.getString("IMPORTCLASS") %>
					</td>
					<th>
						免税目录
					</th>
					<td>
						<%= dto.getString("DIRECTORY") == null ? "&nbsp;" : dto.getString("DIRECTORY") %>
					</td>
				</tr>
				<tr>
					<th>
