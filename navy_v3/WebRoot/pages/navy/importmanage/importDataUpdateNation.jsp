...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			...
			function setRate() {
				var value = document.getElementById("CURRENCYID").value;
				var values = value.split("#");
				document.getElementById("STR_CURRENCYID").value = values[0];
				document.getElementById("STR_RATE").value = values[1];
			}
			...
			function checkinput() {
				...
				if (!check_input(obj, true, 2, 1, 10000000000, "预算金额")) {
					return false;
				}
			
				obj = document.getElementById("STR_COMPACTMONEY");
				if (!check_input(obj, false, 2, 1, 10000000000, "合同金额")) {
					return false;
				}
					...
					<td colspan="4">
						<div class="btu">
							<input type="button" name="save" value="保 存" class="btu_input" style="width:80px"
								onclick="if (checkinput()) submit_form('Navy', 'NavyManage', 'ImportUpdateService', '/pages/navy/importmanage/importDataUpdateNation.jsp');" />
