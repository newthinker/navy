...
<html>
	...
	<body style="background:url(resources/images/common/tbl_bg.gif) top left repeat-x; background-color:#ffffff;">
		<form action="system" method="post">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<td>
						<select name="STR_CURRENCYID" id="STR_CURRENCYID" style="width:200px"
					...
					<td colspan="4">
						<div class="btu">
							<input type="button" name="save" value="保 存" class="btu_input" style="width:80px"
								onclick="if (checkinput()) submit_form('Navy', 'NavyManage', 'ImportAddService', '/pages/navy/importmanage/importDataAdd.jsp');" />
		...
		<script type="text/javascript">
			...
			setSelect("STR_CURRENCYID", "<%= dto.getString("CURRENCYID") == null ? "" : dto.getString("CURRENCYID") %>");
			...
			if ("<%= sOpt %>" == "null" || "<%= sOpt %>" == "refresh") {
				...
				submit_form('Navy', 'NavyManage', 'ImportQueryByIDService', '/pages/navy/importmanage/importDataAdd.jsp');
			}
