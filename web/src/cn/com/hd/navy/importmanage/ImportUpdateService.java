...
public class ImportUpdateService extends BaseService implements IService {
	...
	public Response service(Request request) throws Exception {
		...
		cons.addExpression("COMPACT = '" + navyImp.getCompact() + "' AND IMPORTID != '" + navyImp.getImportid() + "'");
		...
		cons = new Conditions();
		cons.addCondition(new TImport());
		cons.addExpression("PROJECT = '" + navyImp.getProject() + "' AND IMPORTID != '" + navyImp.getImportid() + "'");
