...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="background:url(resources/images/common/tbl_bg.gif) top left repeat-x; background-color:#ffffff;" scroll="yes">
		<form action="system" method="post">
			...
			<input id="str_comid" name="str_comid" type="hidden" value="<%= transport.getString("COMID") == null ? "" : transport.getString("COMID") %>">
			<input id="str_hiwid" name="str_hiwid" type="hidden" value="<%= highway.getString("HIWID") == null ? "" : highway.getString("HIWID") %>">
			...
			<div class="btu">
				<input type="button" name="save" value="保 存" class="btu_input"
					onclick="if (checkinput()) submit_form('Navy', 'NavyManage', 'SupSupportorUpdateService', '/pages/navy/supmanage/supSupportorUpdate.jsp');" />
		...
		<script type="text/javascript">
			setSelect("STR_L1LOC", "<%= supportor.getString("L1LOC") == null ? "" : supportor.getString("L1LOC") %>");
			setSelect("STR_L2LOC", "<%= supportor.getString("L2LOC") == null ? "" : supportor.getString("L2LOC") %>");
