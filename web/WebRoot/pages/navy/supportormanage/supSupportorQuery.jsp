										...
										<div
											...
											<table border="0" cellpadding="0" cellspacing="0"
												...
												<tr>
													...
													<td width="20%">
														<a href="javascript:window.document.getElementById('str_supid').value='<%= data.getString("SUPID")  %>';submit_form('Navy', 'NavyManage', 'SupSupportorDetailService', '/pages/navy/supportormanage/supportorDetails.jsp?src=supportor');" class="link_blue_table">
															<%
