...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			function selectSup(id, name, addr){
				window.opener.document.getElementById("STR_SUPPORTORID").value = id;
				window.opener.document.getElementById("STR_SUPPORTOR").value = name;
				window.opener.document.getElementById("STR_SUPPORTORADDR").value = addr;
				window.close();
			}
		</script>
	</head>
	...
	<body  style="background:url(resources/images/common/tbl_bg.gif) top left repeat-x; background-color:#ffffff;"
		onload="init('Navy','NavyManage','SupportorQueryService','/pages/navy/supportormanage/selectSupportor.jsp');">
		<form action="system" method="post">
			...
			<center>
				<table width="100%" height="100%" border="0" cellpadding="0"
					...
					<tr>
						<td valign="top" height="1">
							<jsp:include page="selectSupportorParam.jsp?mode=show"></jsp:include>
						</td>
					</tr>
					<tr>
						<td valign="top" height="25">
							<div id="btu_new">
								<img src="resources/images/common/btn_search.gif" alt=" " width="62" height="22"
									onclick="submit_form('Navy','NavyManage','SupportorQueryService','/pages/navy/supportormanage/selectSupportor.jsp');" /> 
							</div>
						</td>
					</tr>
					<tr>
										...
										<div
											...
											<table border="0" cellpadding="0" cellspacing="0"
												...
												<tr>
													...
													<td width="20%">
														<a href="javascript:selectSup('<%= data.showString("SUPID") %>', '<%= data.showString("SUPNAME") %>', '<%= data.showString("ADDRESS") %>')" class="link_blue">
															<%
													...
													<td width="15%">
														&nbsp;&nbsp;&nbsp;<a target="_blank" class="link_blue" href="<%= data.showString("NETADDR", "#") %>"><%= data.showString("NETADDR", "&nbsp;") %></a>
													</td>
													<td>
