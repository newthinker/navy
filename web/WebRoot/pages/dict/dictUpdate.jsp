		...
		<form action="system" method="post">
			...
			<div class="btu">
				<input type="button" name="save" value="保 存" class="btu_input"
					onclick="if (checkinput()) submit_form('HDDict', 'DictManage', 'DictUpdateService', '/pages/dict/dictUpdate.jsp?typeid=<%= typeid %>');" />
				<input type="button" name="save" value="保存并更新业务库" class="btu_input"
					onclick="if (confirm('确定要更新业务库吗') && checkinput()) submit_form('Navy', 'NavyManage', 'NavyDictUpdateService', '/pages/dict/dictUpdate.jsp?typeid=<%= typeid %>');" />
