var icon={
	root	:'resources/images/common/image/root.gif',
	open	:'resources/images/common/image/open.png',
	close	:'resources/images/common/image/close.png',
	file	:'resources/images/common/image/file.png',
	Rplus	:'resources/images/common/image/Rplus.gif',
	Rminus	:'resources/images/common/image/Rminus.gif',
	join	:'resources/images/common/image/T.gif',
	joinbottom:'resources/images/common/image/L.gif',
	plus	:'resources/images/common/image/Tplus.gif',
	plusbottom:'resources/images/common/image/Lplus.gif',
	minus	:'resources/images/common/image/Tminus.gif',
	minusbottom:'resources/images/common/image/Lminus.gif',
	blank	:'resources/images/common/image/blank.gif',
	line	:'resources/images/common/image/I.gif'
};
var Global={
	id:0,
...
alert(this.container.parentNode.parentNode.childNodes.length);
alert(this.container.parentNode.parentNode.childNodes[1].childNodes[1].src);
	for(var i=0;i<this.container.parentNode.parentNode.childNodes.length;i++){
		if(this.container.parentNode.childNodes[i]!=this.container.innerHTMl){
			alert(this.container.parentNode.parentNode.childNodes[i].src);
			alert(this.container.parentNode.childNodes.length)
			this.container.parentNode.childNodes[i].lastChild.style.display='none';
		}
	}

	this.container.parentNode.previousSibling.lastChild.style.display='none';
	this.container.parentNode.previousSibling.lastChild.previousSibling.previousSibling.src="../../image/close.png";
	this.container.parentNode.previousSibling.lastChild.previousSibling.previousSibling.previousSibling.src="../../image/Tplus.gif";
*/
}
/*
treeItem.prototype.closeSibling = function(){
	...
	for(var i=0;i<this.parent.childNodes.length;i++){
		if(this.parent.childNodes[i] == this){
			...
			if(this.parent.childNodes[i].container.style.display==""){
