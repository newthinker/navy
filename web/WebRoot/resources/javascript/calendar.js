...
function drawCld(SY,SM) {
   ...
   //YMQG.innerHTML = '农历' + cyclical(SY-1900+36) + '年&nbsp;【'+Animals[(SY-4)%12]+'】';
   ...
   if(sObj.innerHTML!='') {
      ...
      */
      s='<TABLE WIDTH="100%" BORDER=0 CELLPADDING="0" CELLSPACING=0><TR><TD>' +
         ...
         '<font color="#000000">农历'+cld[d].cYear+'年'+(cld[d].isLeap?'闰':'')+monthNong[cld[d].lMonth]+'月'+cDay(cld[d].lDay)+'</font><br>'+
...
function mOut() {
        ...
        document.all["detail"].innerHTML = "将鼠标移到日期上<br>在此显示农历";
}
