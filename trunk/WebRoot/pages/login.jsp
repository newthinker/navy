				...
				<div id="login_middle">
				  ...
				  <tr>
				    <td width="261" id="login_middle_user">用户名：
				      <input type="text" name="STR_LOGINNAME" id="STR_LOGINNAME" class="login_input" onkeydown="login();" tabindex="1" /></td>
				  ...
				  <tr>
				    <td id="login_middle_password">密&nbsp;&nbsp;码：
				      <input type="password" name="STR_LOGINPASS" id="STR_LOGINPASS" class="login_input" onkeydown="login();" tabindex="2" /></td>
				    </tr>
				</table>
