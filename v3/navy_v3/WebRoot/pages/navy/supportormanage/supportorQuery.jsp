...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body  style="background:url(resources/images/common/tbl_bg.gif) top left repeat-x; background-color:#ffffff;"
		onload="init('Navy','NavyManage','SupportorQueryService','/pages/navy/supportormanage/supportorQuery.jsp');">
				...
				<table width="100%" height="100%" border="0" cellpadding="0"
					...
					<tr>
						<td valign="top" height="1">
							<div id="site">&nbsp;当前位置：供应商信息管理</div>
						</td>
					</tr>
					<tr>
						<td valign="top" height="1">
							<jsp:include page="supportorQueryParam.jsp?mode=show"></jsp:include>
						</td>
					</tr>
					<tr>
						<td valign="top" height="25">
							<div id="btu_new">
								...
								<img src="resources/images/common/btn_new.gif" width="62" height="22"
									onclick="window.document.getElementById('str_supid').value='-1';submit_form('Navy', 'NavyManage', 'SupportorQueryByIDService', '/pages/navy/supportormanage/supportorAddIndex.jsp');" />
							</div>
						</td>
					</tr>
					<tr>
										...
										<div
											...
											<table border="0" cellpadding="0" cellspacing="0"
												...
												<tr>
													...
													<td width="20%">
														<a href="javascript:window.document.getElementById('str_supid').value='<%= data.getString("SUPID")  %>';submit_form('Navy', 'NavyManage', 'SupportorDetailService', '/pages/navy/supportormanage/supportorDetails.jsp?src=supportor');" class="link_blue_table">
															<%
													...
													<td>
														...
														<a class="link_blue" href="javascript:if (confirm('确定要删除记录吗？')) {window.document.getElementById('str_supid').value='<%= data.getString("SUPID")  %>';submit_form('Navy', 'NavyManage', 'SupportorDeleteService', '/pages/navy/supportormanage/supportorQuery.jsp?opt=refresh');}">删除</a>
													</td>
												</tr>
												<%
													}
					...
					<tr>
						<td height="30">
							<div class="linepage1">
								...
								<a href="javascript:firstpage('Navy','NavyManage','SupportorQueryService','/pages/navy/supportormanage/supportorQuery.jsp')">首页</a>
								<a href="javascript:prevpage('Navy','NavyManage','SupportorQueryService','/pages/navy/supportormanage/supportorQuery.jsp')">上一页</a>
								<a href="javascript:nextpage('Navy','NavyManage','SupportorQueryService','/pages/navy/supportormanage/supportorQuery.jsp')">下一页</a>
								<a href="javascript:lastpage('Navy','NavyManage','SupportorQueryService','/pages/navy/supportormanage/supportorQuery.jsp')">末页</a>
								转到 
								<select id="page" name="page" 
									onchange="gopage(this.value, 'Navy','NavyManage','SupportorQueryService','/pages/navy/supportormanage/supportorQuery.jsp')">
									<% 
