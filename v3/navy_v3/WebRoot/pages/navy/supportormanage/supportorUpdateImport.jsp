...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			function checkinput() {
				var obj = document.getElementById("STR_SUPENNAME");
				if (!check_input(obj, false, 0, null, null, "供应商名称")) {
					return false;
				}
				
				obj = document.getElementById("STR_SUPNAME");
				if (!check_input(obj, false, 0, null, null, "中文译名")) {
					return false;
				}
	...
	<body scroll="yes"
		...
		<form action="system" method="post">
			...
			<input id="STR_PRODUCTSCLASS" name="STR_PRODUCTSCLASS" type="hidden">
					...
					<td colspan="3" style="border:1px solid #b9c5c9; border-top:none; background-color:#ffffff;">
						<table width="0%" border="0" cellpadding="0" cellspacing="0"
							...
							<tr>
								...
								<td colspan="3">
									<input name="prod_class" style="border:0px;width:16px" type="checkbox" 
			...
			<div class="btu">
				<input type="button" name="save" value="保 存" class="btu_input"
					onclick="if (checkinput()) submit_form('Navy', 'NavyManage', 'SupportorUpdateService', '/pages/navy/supportormanage/supportorUpdateImport.jsp');" />
		...
		<script type="text/javascript">
			setSelect("STR_TYPECODE", "<%= dto.showString("TYPECODE") %>");
