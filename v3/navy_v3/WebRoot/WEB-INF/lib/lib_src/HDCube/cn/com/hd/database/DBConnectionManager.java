...
/* 48 */       (DBConnectionPool)this.dbConnectionPools
/* 48 */       .get(connectionName);
/* 49 */     if (pool != null) {
...
/* 57 */       (DBConnectionPool)this.dbConnectionPools
/* 57 */       .get(connectionName);
/* 58 */     if (pool != null) {
...
/* 66 */       (DBConnectionPool)this.dbConnectionPools
/* 66 */       .get(connectionName);
/* 67 */     if (pool != null)
...
/* 84 */         (DBConnectionPool)this.dbConnectionPools
/* 84 */         .get(V_Sets.nextElement());
...
/* 91 */       (DBConnectionPool)this.dbConnectionPools
/* 91 */       .get(connectionName);
/* 92 */     if (pool != null) {
