...
/*  194 */             field.set(baseDTO, 
/*  195 */               Integer.valueOf(dto
...
/*  207 */               Long.valueOf(dto
/*  207 */               .getString(field.getName().toUpperCase())));
...
/*  219 */               Double.valueOf(dto
/*  219 */               .getString(field.getName().toUpperCase())));
...
/*  231 */               Boolean.valueOf(dto
/*  231 */               .getString(field.getName().toUpperCase())));
/*      */           }
...
/*  975 */       Debug.debugMessage(0, this.request.getResponseSystemName(), this.request.getResponseSubsystemName(), this.request.getResponseServiceName(), sConfigName + " is a directory but no a config file.");
/*  976 */       return null;
/*      */     }
/*      */ 
/*  979 */     if (!file.exists()) {
